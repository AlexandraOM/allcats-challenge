...
To clone this project copy and paste 
```git clone https://github.com/AlexandraOM/allcats-challenge.git ``` into your terminal. CD into the project and you can run:
